      ...
      if (!Array.isArray(patchesData) || patchesData.length === 0) {
        patchesData = [
          ...
          },
          {
            name: "v2.8.4",
            html_url:
              "https://github.com/MorpheApp/morphe-patches/releases/tag/v2.8.4",
                        ...
                        <div class="changelog-header">
                          <div>
                            ...
                            <div class="changelog-meta">
                              <span class="badge ${release.appType}">${release.appType === "manager" ? "Manager" : "Patches"}</span>
                              ${isDev ? '<span class="badge dev">Dev</span>' : ""}
