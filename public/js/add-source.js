...
(function () {
  ...
  var intentParams =
    "github=" + encodedRepo + (encodedName ? "&name=" + encodedName : "");
  var intentLink =
  ...
  function applyI18nAndShow() {
    if (window.i18n) {
      ...
      document.getElementById("source-label").textContent = window.i18n.t(
  ...
  if (
    ...
    Object.keys(window.i18n.translations).length
  ) {
    applyI18nAndShow();
  } else {
